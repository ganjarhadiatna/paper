...
Route::get('/explore/fresh', 'MainController@fresh');
Route::get('/explore/populars', 'MainController@popular');
Route::get('/explore/trendings', 'MainController@trending');
Route::get('/explore/news/{idtags}', 'MainController@news');
